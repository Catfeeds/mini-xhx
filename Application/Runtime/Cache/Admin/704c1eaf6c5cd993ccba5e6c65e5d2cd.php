                            ...
                            <div class="ibox-content">
                                <form method="post" action="" class="form-horizontal">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">关联的权限</label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" name="module" value="<?php echo ($info["module"]); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="radio col-sm-2">
                                                <label>
                                                    <input type="radio" <?php if($info["status"] == 1): ?>checked<?php endif; ?> id="optionsRadios1" name="status" value="1">开启 
                                                </label>
                                            </div>
                                            <div class="radio col-sm-2">
                                                <label>
                                                    <input type="radio" <?php if($info["status"] == 0): ?>checked<?php endif; ?> id="optionsRadios2" name="status" value="0">关闭
                                                </label>
                                            </div>
                                        </div>
                                    </div>
