                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <ol class="breadcrumb">
                                    <li><a href="#">主页</a></li>
									<li>育儿百科管理</li>
                                    <li><strong>育儿百科列表</strong></li>
                                </ol>
                            </div>
                            <div class="ibox-content">
								<div class="margin_block ">
                                    <a href="<?php echo U('Child/add');?>" class="btn btn-primary">添加</a>
                                </div>
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                            ...
                                            <td><img src="<?php echo ($list["img"]); ?>" width="40" heigth="40" /></td>
                                            <td><a href="<?php echo ($list["url"]); ?>" target="_blank"><?php echo ($list["url"]); ?></a></td>
                                            <td><?php echo ($list["cateName"]); ?></td>
                                            <td>
                                                <?php if($list["is_show"] == 1): ?>已经发布
                                                    <?php else: ?>
                                                    等待发布<?php endif; ?>
                                            </td>
                                            <td>
											<a href="<?php echo U('Child/add',array('id'=>$list['id']));?>" class="red mar_left">编辑 </a>
											
                                            <a href="<?php echo U('Child/del',array('id'=>$list['id']));?>" class="red mar_left">删除</a>
											</td>
