                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <ol class="breadcrumb">
                                    <li><a href="#">主页</a></li>
									<li>商品管理</li>
                                    <li><strong>商品列表</strong></li>
                                </ol>
                            </div>
                            <div class="ibox-content">
                            	 <form action="/admin.php/Goods/index"  method="get" id="orderform" class="form-horizontal">
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label">商品名称</label>
                                        <div class="col-sm-2">
                                            <input type="text" name="name" value="<?php echo ($where["name"]); ?>" class="form-control">
                                        </div>
                                        <div class="col-sm-2">
								...
								<div class="margin_block ">
                                    <a href="<?php echo U('Goods/add');?>" class="btn btn-primary">添加</a>
                                </div>
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                            ...
                                            <td><?php echo ($list["g_sale_num"]); ?></td>
                                            <td><?php echo ($list["g_strawberry"]); ?></td>
                                            <!--<td><?php echo ($list["g_peach"]); ?></td>-->
                                            <td>
											<a href="<?php echo U('Goods/add',array('id'=>$list['g_id']));?>" class="red mar_left">编辑 </a>
											
                                            <a href="<?php echo U('Goods/del',array('id'=>$list['g_id']));?>" class="red mar_left">删除</a>
											</td>
