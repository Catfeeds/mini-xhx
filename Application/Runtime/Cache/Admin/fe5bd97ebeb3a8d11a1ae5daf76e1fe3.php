                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <ol class="breadcrumb">
                                    <li><a href="#">主页</a></li>
									<li>权限管理</li>
                                    <li><strong>权限组管理</strong></li>
                                </ol>
                            </div>
                            <div class="ibox-content">
								<div class="margin_block ">
                                    <a href="<?php echo U('Root/groupadd',array('token'=>$token));?>" class="btn btn-primary">添加</a>
                                </div>
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX">
											...
											<td>
											<a href="<?php echo U('Root/groupadd',array('id'=>$list['id']));?>" class="red mar_left">编辑组信息</a>
                                            <a href="<?php echo U('Root/groupsta',array('id'=>$list['id']));?>" class="red mar_left">关闭</a>
											<a href="javascript:del(<?php echo ($list["id"]); ?>)" class="red mar_left">删除</a>
											</td>
...
<script type="text/javascript">
	function del(aa){
		if(confirm("确定要删除数据吗")){
			location.href="/admin.php/Root/groupdel/id/"+aa;
		}
	}
</script>