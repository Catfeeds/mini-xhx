                            ...
                            <div class="ibox-content">
                                <form method="post" action="" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" name="url" value="<?php echo ($info["url"]); ?>" class="form-control"><span style="color:red">设置外部地址表示跳转到其他https页面</span>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" name="appid" value="<?php echo ($info["appid"]); ?>" class="form-control"><span style="color:red">设置appid表示跳转到小程序</span>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" name="path" value="<?php echo ($info["path"]); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-2">
                                            ...
                                            <button class="btn btn-primary  col-sm-offset-1" type="submit" id="cancelShow">取消发布</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
