                ...
                <div class="row">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
								<div class="margin_block col-sm-12">
                                    <a href="<?php echo U('Root/useradd',array('token'=>$token));?>" class="btn btn-primary">添加</a>
                                </div>
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX">
											...
											<td>
											<a href="<?php echo U('Root/useradd',array('id'=>$list['id']));?>" class="red mar_left">编辑</a>
                                            <a href="<?php echo U('Root/usersta',array('id'=>$list['id']));?>" class="red"><?php if($list["status"] == 1): ?>关闭<?php else: ?>开启<?php endif; ?></a>
											</td>
