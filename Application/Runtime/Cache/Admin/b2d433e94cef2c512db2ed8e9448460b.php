                            ...
                            <div class="ibox-content">
                                <form method="post" action="" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" name="name" value="<?php echo ($info["g_name"]); ?>" class="form-control">
                                        </div>
                                    </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3" style="position: relative;">
											<?php if($info["g_img"] == ''): ?><img src="/Themes/Admin/img/no_pic.png" id="site_logo" width="80px" height="80px"> 
											<?php else: ?> 
												<img src="<?php echo ($info["g_img"]); ?>" id="site_logo" width="80px" height="80px"><?php endif; ?>
										</div>
									</div>
									<div class="hr-line-dashed"></div>
									<div class="form-group">
                                        <label class="col-sm-2 control-label">兑换需要草莓数量</label>
                                        <div class="col-sm-2">
                                            <input type="text" name="strawberry" value="<?php echo ($info["g_strawberry"]); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <!--<div class="hr-line-dashed"></div>-->
									<!--<div class="form-group">-->
                                        <!--<label class="col-sm-2 control-label">兑换需要水蜜桃数量</label>-->
                                        <!--<div class="col-sm-2">-->
                                            <!--<input type="text" name="peach" value="<?php echo ($info["g_peach"]); ?>" class="form-control"><br/><span style="color:red">如果草莓和水蜜桃都有填写，水蜜桃优先显示</span>-->
                                        <!--</div>-->
                                    <!--</div>-->
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
										...
										<div class="col-sm-8">
											<script id="editor" type="text/plain" style="width: 100%; height: 240px;"><?php echo (htmlspecialchars_decode($info["g_desc"])); ?></script>
										</div>
									</div>
									<div class="hr-line-dashed"></div>
                                    <div class="form-group">
