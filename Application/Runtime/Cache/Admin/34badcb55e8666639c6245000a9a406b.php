                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <ol class="breadcrumb">
                                    <li><a href="#">主页</a></li>
                                    <li><a>配置管理</a></li>
                                    <li><strong>更新配置</strong></li>
                                </ol>
                            </div>
                            <div class="ibox-content">
                                <form method="post" action="" class="form-horizontal">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">注册登录返还草莓</label>
                                        <div class="col-sm-2">
                                            <input type="text" name="register" value="<?php echo ($info["register"]); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">邀请好友返还草莓</label>
                                        <div class="col-sm-2">
                                            <input type="text" name="invite" value="<?php echo ($info["invite"]); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">签到返还草莓</label>
                                        <div class="col-sm-10">
                                            <?php if(is_array($info["sign"])): $i = 0; $__LIST__ = $info["sign"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sign): $mod = ($i % 2 );++$i;?><input type="text" name="sign[]" value="<?php echo ($sign); ?>" class="form-control" style="display:inline-block;width:60px"><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">分享知识返还草莓</label>
                                        <div class="col-sm-2">
                                            <input type="text" name="share" value="<?php echo ($info["share"]); ?>" class="form-control">
                                        </div>
                                        <label class="col-sm-2 control-label">每天封顶</label>
                                        <div class="col-sm-2">
                                            <input type="text" name="maxshare" value="<?php echo ($info["maxShare"]); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">知识评论返还草莓</label>
                                        <div class="col-sm-2">
                                            <input type="text" name="comment" value="<?php echo ($info["comment"]); ?>" class="form-control">
                                        </div>
                                        <label class="col-sm-2 control-label">每天封顶</label>
                                        <div class="col-sm-2">
                                            <input type="text" name="maxcomment" value="<?php echo ($info["maxComment"]); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">生日返还草莓</label>
                                        <div class="col-sm-2">
                                            <input type="text" name="birth" value="<?php echo ($info["birth"]); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">草莓兑换水蜜桃比例</label>
                                        <div class="col-sm-2">
                                            <input type="text" name="rate" value="<?php echo ($info["rate"]); ?>" class="form-control">
                                        </div>
                                    </div>
									<div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-2">
                                            ...
                                            <button class="btn btn-primary col-sm-offset-1" type="submit">取消</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
