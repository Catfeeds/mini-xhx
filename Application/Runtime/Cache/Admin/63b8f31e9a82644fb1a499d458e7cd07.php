                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <ol class="breadcrumb">
                                    <li><a href="#">主页</a></li>
                                    <li><a>订单管理</a></li>
                                    <li><strong>订单编辑</strong></li>
                                </ol>
                            </div>
                            <div class="ibox-content">
                                <form method="post" action="" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">订单序号</label>
                                        <div class="col-sm-2">
                                            <?php echo ($info["sn"]); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">寄送的物流公司</label>
                                        <div class="col-sm-2">
                                            <input type="text" name="delivery" value="<?php echo ($info["delivery"]); ?>" class="form-control">
                                        </div>
                                    </div>
                                     <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">寄送的物流单号</label>
                                        <div class="col-sm-2">
                                            <input type="text" name="deliverycode" value="<?php echo ($info["delivery_code"]); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                        	<select name="status" class="form-control m-b">
                                        		<option value="1" <?php if($info["status"] == 1): ?>selected<?php endif; ?>>完成</option>
                                        		<option value="2" <?php if($info["status"] == 2): ?>selected<?php endif; ?>>等待发货</option>
                                        		<option value="3" <?php if($info["status"] == 3): ?>selected<?php endif; ?>>已经发货</option>
                                        	</select>
                                        </div>
                                    </div>
									<div class="hr-line-dashed"></div>
