...
<body>
 ...
 if($auth->check(MODULE_NAME . '/Cache/set',session('admin_id')) == true){ ?>
        ...
        <div class="gray-bg dashbard-1">
                <div class="row">
                		<script type="text/javascript" charset="utf-8" src="/Themes/Admin/js/plugins/ueditor/ueditor.config.js"></script>
						<script type="text/javascript" charset="utf-8" src="/Themes/Admin/js/plugins/ueditor/ueditor.all.min.js"> </script>
						<script type="text/javascript" charset="utf-8" src="/Themes/Admin/js/plugins/ueditor/lang/zh-cn/zh-cn.js"></script>
						<script type="text/javascript">
							var ue = UE.getEditor('editor',{
								imageUrl:"<?php echo U('Company/addimg');?>" ,        //图片上传提交地址
							});
						</script>
                                ...
                                <form method="post" action="" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-3" style="position: relative;">
											<?php if($info["img"] == ''): ?><img src="/Themes/Admin/img/no_pic.png" id="site_logo" width="80px" height="80px"> 
											<?php else: ?> 
												<img src="<?php echo ($info["img"]); ?>" id="site_logo" width="80px" height="80px"><?php endif; ?>
										</div>
									</div>
                                    <div class="hr-line-dashed"></div>
                                     <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
											<select class="form-control m-b" name="cid">
												<?php if(is_array($cateList)): $k = 0; $__LIST__ = $cateList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($k % 2 );++$k;?><option data-type="<?php echo ($cate); ?>" <?php if($k == $info['cid']): ?>selected = "selected"<?php endif; ?> value="<?php echo ($k); ?>"><?php echo ($cate); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
										...
										<div class="col-sm-8">
											<script id="editor" type="text/plain" style="width: 100%; height: 240px;"><?php echo (htmlspecialchars_decode($info["content"])); ?></script>
										</div>
									</div>
									<div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-2">
                                            ...
                                            <button class="btn btn-primary" type="submit" id="noShow">保存</button>
                                            <button class="btn btn-primary col-sm-offset-1" type="submit">取消</button>
                                            <button class="btn btn-primary  col-sm-offset-1" type="submit" id="isShow">保存并发布</button>
                                            <?php if($info["is_show"] == 1): ?><button class="btn btn-primary  col-sm-offset-1" type="submit" id="cancelShow">取消发布</button><?php endif; ?>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <script>
            $("#noShow,#cancelShow").click(function(){
                $("input[name='is_show']").val(2);
            });
